---
title: "Examining the features of viral pathogenesis and the ability to infect spillover hosts"
subtitle: ""
...
# Summary/Abstract
Viral spillover is a complex process with a range of viral and host factors at play. Much emphasis has been placed on the ecological and epidemiological factors at play in viral spillover, with changes in reservoir host distribution and increased contact with susceptible spillover hosts being major players. However, there are many more interactions between reservoir host viruses and potential spillover hosts than the number of viruses which indeed spillover. We hypothesise that there may be traits related to the pathogenesis of infection which also play a role in spillover. 
...
The data is a series of traits related to the pathogenesis of viral infection in a range of RNA viruses and whether the traits are present or absent in each particular virus. The data is being compiled in the lab currently from searching the available literature.


## Questions/Hypotheses to be addressed
1. Is there an association between cell type infected and spillover?


2. Does the level of receptor conservation across species influence the ability to infect a new host species?


3. Does the ability infect macrophages increase the likelihood of spillover?


# Methods and Results

In terms of analysis, the aim is to look for associations between particular traits of the pathogenesis of infection and zoonotic ability.
