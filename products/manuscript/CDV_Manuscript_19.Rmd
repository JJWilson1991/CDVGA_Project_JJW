...
```{r, plotly2, fig.cap= "**Figure 12: Cases of CDV in Gray Foxes and Raccoons in Georgia counties, from cases submitted to SCWDS, 1975-2013.**", echo=FALSE}
knitr:: include_graphics(here("results", "Figures", "Species_County_stationary.png"))
...
```
#put model between dollar signs
