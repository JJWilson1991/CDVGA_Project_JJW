...
##Overview of Data
Data contained the the follwing variables; Case number, State, county, area, Sex, Species, Age and collection year. Additional data incluing specific collection dates was also used from a serpearte spread sheet for the time series analysis.
...
## Time Series analsys
time series analysis and ARIMA model construction was conducted using the "fpp2" package from [Forecating: principles and practice, Hyndman & Athanasopoulos](https://otexts.com/fpp2/).[@Hyndman2018]
...
```{r, resultfigure3, fig.cap= 'Raccoon and Gray Fox cases in Georgia presented to SCWDS, 1975-2013, and human population density', echo=FALSE, warning=FALSE, message=FALSE}
knitr:: include_graphics(here("results", "figures", "Cases_Density_Map.png"))

```


```{r, resultfigure3, fig.cap= 'Raccoon and Gray Fox cases per spm against human population density', echo=FALSE, warning=FALSE, message=FALSE}
