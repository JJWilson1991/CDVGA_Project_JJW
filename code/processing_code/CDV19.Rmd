...
Raw_CDV_old <- read_csv(here("data", "raw_data", "Canine_Distemper_Virus_Reports.csv"))
...
```{r}
#import 14-19 data
Raw_CDV_2019 <- read_csv(here("data","raw_data","2014_to_2019_scwds_data.csv"))
...
```{r}
End_13 <- read.csv(here("data", "raw_data", "end_of_2013_cdv_scwds.csv"))
...
CDV19_clean<-CDV19_clean5[-c(1,8)]
```
