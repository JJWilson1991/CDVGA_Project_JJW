...
```{r}
library(readxl)
CDV_data_Raw <- read_excel("C:/Users/Jonathan/Desktop/epid8060fall2019/JonathanWilson_Project/data/raw_data/CDV data/SCWDS_CDV - Copy.xls")

Raw_CDV_Mainsheet <- read_excel("C:/Users/Jonathan/Desktop/epid8060fall2019/JonathanWilson_Project/data/raw_data/CDV data/SCWDS_CDV - Copy.xls", sheet = "Data")
...
DFRawCDVcol <- DFRawCDV[-c(1,9, 10, 11, 12, 13, 14)]
DFRawCDVcol
...
saveRDS(CDV_Clean, file = "../../data/processed_data/CDVprocesseddata.rds")
