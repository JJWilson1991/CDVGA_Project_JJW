...
#     RaccoonLag4 = stats::lag(f6_ts[,"Raccoon"],-4),
#     RaccoonLag5 = stats::lag(f6_ts[,"Raccoon"],-5),
#     RaccoonLag6 = stats::lag(f6_ts[,"Raccoon"],-6),
#      RaccoonLag7 = stats::lag(f6_ts[,"Raccoon"],-7),
#     RaccoonLag8 = stats::lag(f6_ts[,"Raccoon"],-8),
#     RaccoonLag9 = stats::lag(f6_ts[,"Raccoon"],-9),
#     RaccoonLag10 = stats::lag(f6_ts[,"Raccoon"],-10),
#     RaccoonLag11 = stats::lag(f6_ts[,"Raccoon"],-11),
#     RaccoonLag12 = stats::lag(f6_ts[,"Raccoon"],-12)) %>%
#   head(NROW(f6_ts))
# 
# Fox_lag <- cbind(
...
#     FoxLag4 = stats::lag(f6_ts[,"Gray_Fox"],-4),
#     FoxLag5 = stats::lag(f6_ts[,"Gray_Fox"],-5),
#     FoxLag6 = stats::lag(f6_ts[,"Gray_Fox"],-6),
#      FoxLag7 = stats::lag(f6_ts[,"Gray_Fox"],-7),
#     FoxLag8 = stats::lag(f6_ts[,"Gray_Fox"],-8),
#     FoxLag9 = stats::lag(f6_ts[,"Gray_Fox"],-9),
#     FoxLag10 = stats::lag(f6_ts[,"Gray_Fox"],-10),
#     FoxLag11 = stats::lag(f6_ts[,"Gray_Fox"],-11),
#     FoxLag12 = stats::lag(f6_ts[,"Gray_Fox"],-12)) %>%
#   head(NROW(f6_ts))
# 
# 
...
#   stationary=TRUE)
# fit5 <- auto.arima(f6_ts[4:n,1], xreg=Raccoon_lag[4:n,1:5],
#   stationary=TRUE)
# fit6 <- auto.arima(f6_ts[4:n,1], xreg=Raccoon_lag[4:n,1:6],
#   stationary=TRUE)
# fit7 <- auto.arima(f6_ts[4:n,1], xreg=Raccoon_lag[4:n,1:7],
#   stationary=TRUE)
# fit8 <- auto.arima(f6_ts[4:n,1], xreg=Raccoon_lag[4:n,1:8],
#   stationary=TRUE)
# fit9 <- auto.arima(f6_ts[4:n,1], xreg=Raccoon_lag[4:n,1:9],
#   stationary=TRUE)
# fit10 <- auto.arima(f6_ts[4:n,1], xreg=Raccoon_lag[4:n,1:10],
#   stationary=TRUE)
# fit11 <- auto.arima(f6_ts[4:n,1], xreg=Raccoon_lag[4:n,1:11],
#   stationary=TRUE)
# fit12 <- auto.arima(f6_ts[4:n,1], xreg=Raccoon_lag[4:n,1:12],
#   stationary=TRUE)
# fit13 <- auto.arima(f6_ts[4:n,1], xreg=Raccoon_lag[4:n,1:13],
#   stationary=TRUE)
# summary(fit1)
# summary(fit2)
# summary(fit3)
...
#     Summary_fit5 = summary(fit5)[,"RMSE"],
#     Summary_fit6 = summary(fit6)[,"RMSE"],
#     Summary_fit7 = summary(fit7)[,"RMSE"],
#         Summary_fit8 = summary(fit8)[,"RMSE"],
#     Summary_fit9 = summary(fit9)[,"RMSE"],
#     Summary_fit10 = summary(fit10)[,"RMSE"],
#     Summary_fit11 = summary(fit11)[,"RMSE"],
#     Summary_fit12 = summary(fit12)[,"RMSE"],
#     Summary_fit13 = summary(fit13)[,"RMSE"],
...
# rfit1 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1],
#   stationary=TRUE)
# rfit2 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:2],
#   stationary=TRUE)
# rfit3 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:3],
#   stationary=TRUE)
# rfit4 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:4],
#   stationary=TRUE)
# rfit5 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:5],
#   stationary=TRUE)
# rfit6 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:6],
#   stationary=TRUE)
# rfit7 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:7],
#   stationary=TRUE)
# rfit8 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:8],
#   stationary=TRUE)
# rfit9 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:9],
#   stationary=TRUE)
# rfit10 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:10],
#   stationary=TRUE)
# rfit11 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:11],
#   stationary=TRUE)
# rfit12 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:12],
#   stationary=TRUE)
# rfit13 <- auto.arima(f6_ts[4:n,2], xreg=Fox_lag[4:n,1:13],
#   stationary=TRUE)
# 
# 
# 
...
#       Summary_rfit1 = summary(rfit1)[,c("RMSE")],
#     Summary_rfit2 = summary(rfit2)[,"RMSE"],
#     Summary_rfit3 = summary(rfit3)[,"RMSE"],
#     Summary_rfit4 = summary(rfit4)[,"RMSE"],
#     Summary_rfit5 = summary(rfit5)[,"RMSE"],
#     Summary_rfit6 = summary(rfit6)[,"RMSE"],
#     Summary_rfit7 = summary(rfit7)[,"RMSE"], 
#    Summary_rfit8 = summary(rfit8)[,"RMSE"],
#     Summary_rfit9 = summary(rfit9)[,"RMSE"],
#     Summary_rfit10 = summary(rfit10)[,"RMSE"],
#     Summary_rfit11 = summary(rfit11)[,"RMSE"],
#     Summary_rfit12 = summary(rfit12)[,"RMSE"],
#     Summary_rfit13 = summary(rfit13)[,"RMSE"],
...
#      RaccoonLag4tr = stats::lag(f6_ts_train[,"Raccoon"],-4),
#      RaccoonLag5tr = stats::lag(f6_ts_train[,"Raccoon"],-5),
#      RaccoonLag6tr = stats::lag(f6_ts_train[,"Raccoon"],-6),
#   RaccoonLag7tr = stats::lag(f6_ts_train[,"Raccoon"],-7),
#     RaccoonLag8tr = stats::lag(f6_ts_train[,"Raccoon"],-8),
#     RaccoonLag9tr = stats::lag(f6_ts_train[,"Raccoon"],-9),
#     RaccoonLag10tr = stats::lag(f6_ts_train[,"Raccoon"],-10),
#      RaccoonLag11tr = stats::lag(f6_ts_train[,"Raccoon"],-11),
#      RaccoonLag12tr = stats::lag(f6_ts_train[,"Raccoon"],-12)) %>%
...
#     FoxLag4 = stats::lag(f6_ts_train[,"Gray_Fox"],-4),
#     FoxLag5 = stats::lag(f6_ts_train[,"Gray_Fox"],-5),
#     FoxLag6 = stats::lag(f6_ts_train[,"Gray_Fox"],-6),
#     FoxLag7 = stats::lag(f6_ts_train[,"Gray_Fox"],-7),
#     FoxLag8 = stats::lag(f6_ts_train[,"Gray_Fox"],-8),
#     FoxLag9 = stats::lag(f6_ts_train[,"Gray_Fox"],-9),
#     FoxLag10 = stats::lag(f6_ts_train[,"Gray_Fox"],-10),
#     FoxLag11= stats::lag(f6_ts_train[,"Gray_Fox"],-11),
#     FoxLag12 = stats::lag(f6_ts_train[,"Gray_Fox"],-12)) %>%
#   head(NROW(f6_ts_train))
# 
# ```
# 
...
# RRMSEtr <- rbind(
#   R_Fit1_train = accuracy(rfit1tr)[,("RMSE")],
#   R_Fit2_train = accuracy(rfit2tr)[,("RMSE")],
#   R_Fit3_train = accuracy(rfit3tr)[,("RMSE")], 
#   R_Fit4_train = accuracy(rfit4tr)[,("RMSE")],
#   R_Fit5_train = accuracy(rfit5tr)[,("RMSE")],
#   R_Fit6_train = accuracy(rfit6tr)[,("RMSE")],
#   R_Fit7_train = accuracy(rfit7tr)[,("RMSE")],
#   R_Fit8_train = accuracy(rfit8tr)[,("RMSE")],
#   R_Fit9_train = accuracy(rfit9tr)[,("RMSE")],
#   R_Fit10_train = accuracy(rfit10tr)[,("RMSE")],
#   R_Fit11_train = accuracy(rfit11tr)[,("RMSE")],
#   R_Fit12_train = accuracy(rfit12tr)[,("RMSE")],
#   R_Fit13_train = accuracy(rfit13tr)[,("RMSE")],
#   R_Fit14_train = accuracy(rfit14tr)[,("RMSE")],
#   R_Null_train = accuracy(Null_R_train)[,("RMSE")])
RRMSEte <- rbind(
