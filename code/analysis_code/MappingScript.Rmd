...
```
```{r}
#now we'll subset for raccoon and gray fow and compare the county distribution
...
Can I get the case data for different counties in different years plotted on same map using diff colours per year?
