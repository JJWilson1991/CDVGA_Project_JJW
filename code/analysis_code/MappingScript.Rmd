...
saveRDS(CDVGA2, file = "../../data/processed_data/CDVGA2.rds")
...
GAC <-  GAC %>% mutate(County = recode(County, "De kalb" = "DeKalb", "Jeff davis" = "Jeff Davis", "Ben hill" = "Ben Hill"))
```
```{r}
...
saveRDS(RACnum, file = "../../data/processed_data/RaCFoxMappingData.rds")
```
...
saveRDS(centrLL, file = "../../data/processed_data/GACentroiddata.rds")
```
```{r}
