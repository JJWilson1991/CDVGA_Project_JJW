...
#as you see, when the numbers get small, the outcome isn't so reliable looking
```
```{r}
...
#this might have potnetial, but doesn't really solve the problem of trying to isolate the spatial component, as you still end up pooling over time
```
